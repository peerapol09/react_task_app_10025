...
// import { useNavigate } from 'react-router-domm'
import Swal from 'sweetalert2'
 
export default function Home() {
const showfunctionalert = (msg) => {
  Swal.fire({
        icon: 'warning',
        iconColor: 'F59800',
        title: msg,
        confirmButton: 'ตกลง',
        confirmButtonColor: '#004959'
      })
}
  ...
  const handleTaskClick = () => {
    ...
    if (secureCode === '') {
      ...
      //   icon: 'warning',
      //   iconColor: 'F59800',
      //   title: 'กรุณาใส่ Secure Code',
      //   confirmButton: 'ตกลง',
      //   confirmButtonColor: '#004959'
      // })
      showfunctionalert('กรุณาใส่ Secure Code')
      return;
    }
    ...
    if(secureCode.toLowerCase() === 'dtisau') {
      ...
      //   confirmButtonColor: '#004959'
      // })
      showfunctionalert('Secure Code ไม่ถูกต้อง')  
    }
  }
